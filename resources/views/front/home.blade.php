					...
					<div class="item">
						<div class="woo_category_box border_style rounded" style="background-color: <?php echo $strings[$key % $count]; ?>">
							<div class="woo_cat_thumb">
								<a href="{{URL::to('products/'.$category->slug)}}"><img src='{{ asset("images/category/".$category->image) }}' class="img-fluid" alt="" /></a>
							</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-6 col-md-6 col-sm-12 ml-auto">
				<img class="pro_img img-fluid w100" src='{{ asset("images/about/".$getabout->image) }}' width="500px" height="500px">
			</div>
									...
									<div class="single_customers_caption">
										...
										<div class="review_author_box">
											<div class="reviews_img">
												<img src='{{ asset("images/profile/".$review["users"]->profile_image) }}' class="img-fluid" alt="" />	
											</div>
