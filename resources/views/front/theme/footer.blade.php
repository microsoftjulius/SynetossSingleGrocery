								...
								<div class="footer_widget">
									...
									<ul class="footer-menu">
										...
										@if($getabout->ios != "")
											...
											<li><a href="{{$getabout->ios}}" target="_blank"><img src="{{ asset('front/img/apple-store.svg') }}" alt="" width="120px;"></a></li>

										@endif

										@if($getabout->android != "")

											<li><a href="{{$getabout->android}}" target="_blank"><img src="{{ asset('front/img/play-store.png') }}" alt="" width="120px;"></a></li>
		...
		<script src="{{ asset('front/js/smoothproducts.js') }}"></script>

		<script src="{{ asset('front/js/jquery-rating.js') }}"></script>
