...
<html lang="en">
	...
	<head>
		...
		<link rel="icon" href='{{ asset('images/about/'.$getabout->favicon) }}' type="image/gif" sizes="16x16">
						...
						<div class="row align-items-center">
							...
							<div class="col-lg-2 col-md-2 col-sm-3 col-4">
								...
								<a class="nav-brand" href="{{URL::to('/')}}">
									...
									<img src="{{ asset('front/img/logo-light.png') }}" class="logo" alt="" style="height: 50px;" />
