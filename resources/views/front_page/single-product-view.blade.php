                        ...
                        <div class="col-md-12">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="/new-products">Vegetables & Fruits</a></li>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4">
                                        <div id="sync1" class="owl-carousel owl-theme">
                                            <div class="item">
                                                <img src="{{asset('front_pages/images/product/big-1.jpg')}}" alt="">
                                            </div>
                                            <div class="item">
                                ...
                                <div class="pdpt-body scrollstyle_4">
                                    <div class="cart-item border_radius">
                                        <a href="single_product_view.html" class="cart-product-img">
                                            <img src="{{asset('front_pages/images/product/img-6.jpg')}}" alt="">
                                    ...
                                    <div class="cart-item border_radius">
                                        <a href="single_product_view.html" class="cart-product-img">
                                        <img src="{{asset('front_pages/images/product/img-5.jpg')}}" alt="">
                                        </a>
                                        <div class="cart-text">
                                            <h4>Product Title Here</h4>
                                            <div class="cart-radio">
                        ...
                        <div class="col-md-12">
                            <div class="owl-carousel featured-slider owl-theme">
                                ...
                                <div class="item">
                                    <div class="product-item">
                                        <a href="single_product_view.html" class="product-img">
                                            <img src="{{asset('front_pages/images/product/img-3.jpg')}}" alt="">
                                            <div class="product-absolute-options">
                                ...
                                <div class="item">
                                    <div class="product-item">
                                        <a href="single_product_view.html" class="product-img">
                                            <img src="{{asset('front_pages/images/product/img-4.jpg')}}" alt="">
                                            <div class="product-absolute-options">
                                ...
                                <div class="item">
                                    <div class="product-item">
                                        <a href="single_product_view.html" class="product-img">
                                            <img src="{{asset('front_pages/images/product/img-7.jpg')}}" alt="">
                                            <div class="product-absolute-options">
                                ...
                                <div class="item">
                                    <div class="product-item">
                                        <a href="single_product_view.html" class="product-img">
                                            <img src="{{asset('front_pages/images/product/img-8.jpg')}}" alt="">
                                            <div class="product-absolute-options">
                                                <span class="offer-badge-1">3% off</span>
                                                <span class="like-icon" title="wishlist"></span>
                                            </div>
