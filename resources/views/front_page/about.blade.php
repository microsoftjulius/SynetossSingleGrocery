            ...
            <div class="life-gambo">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="about-img">
                                <img src="{{asset('front_pages/images/about.svg')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="about-step">
                                <div class="about-step-img">
                                    <img src="{{asset('front_pages/images/about/icon-1.svg')}}" alt="">
                                </div>
                                <h4>400+</h4>
                        ...
                        <div class="col-lg-3">
                            <div class="about-step">
                                <div class="about-step-img">
                                    <img src="{{asset('front_pages/images/about/icon-2.svg')}}" alt="">
                                </div>
                                <h4>2x</h4>
                        ...
                        <div class="col-lg-3">
                            <div class="about-step">
                                <div class="about-step-img">
                                    <img src="{{asset('front_pages/images/about/icon-3.svg')}}" alt="">
                                </div>
                                <h4>10 days</h4>
                        ...
                        <div class="col-lg-3">
                            <div class="about-step">
                                <div class="about-step-img">
                                    <img src="{{asset('front_pages/images/about/icon-4.svg')}}" alt="">
                                </div>
                                <h4>95k</h4>
                            ...
                            <div class="dd-content">
                                <div class="owl-carousel team-slider owl-theme">
                                    <div class="item">
                                        <div class="team-item">
                                            <div class="team-img">
                                                <img src="{{asset('front_pages/images/team/img-1.jpg')}}" alt="">
                                            </div>
                                    ...
                                    <div class="item">
                                        <div class="team-item">
                                            <div class="team-img">
                                                <img src="{{asset('front_pages/images/team/img-2.jpg')}}" alt="">
                                            </div>
                                            <h4>John Doe</h4>
                                    ...
                                    <div class="item">
                                        <div class="team-item">
                                            <div class="team-img">
                                                <img src="{{asset('front_pages/images/team/img-3.jpg')}}" alt="">
                                            </div>
                                    ...
                                    <div class="item">
                                        <div class="team-item">
                                            <div class="team-img">
                                                <img src="{{asset('front_pages/images/team/img-4.jpg')}}" alt="">
                                            </div>
                                            <h4>Zoena Singh</h4>
