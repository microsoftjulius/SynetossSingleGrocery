...
class ClientWishlistController extends Controller
{
    ...
    protected function getClientWishlist(Request $request){
        ...
        return view('front_page.wishlist',compact('user_cart','items_in_cart','total_amount','delivery_charges','total_saving'));
    }
}
