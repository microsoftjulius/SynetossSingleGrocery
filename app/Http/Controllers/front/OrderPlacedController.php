...
class OrderPlacedController extends Controller
{
    ...
    /**
     * this function returns the users placed orders
     */
    protected function getPlacedOrders(Request $request){
        ...
        return view('front_page.order-placed',compact('user_cart','items_in_cart','total_amount','delivery_charges',
        'total_saving'));
    }
}
