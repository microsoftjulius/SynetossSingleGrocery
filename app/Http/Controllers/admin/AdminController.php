...
class AdminController extends Controller {
    ...
    public function home() {
        ...
        $todaysorder=Order::whereDate('created_at', date('Y-m-d'))->count();
        return view('home',compact('getcategory','getitems','getusers','driver','getreview','getorders','order_total','order_tax','getpromocode','todayorders','future_order','date','getdriver','todaysorder'));
    }
